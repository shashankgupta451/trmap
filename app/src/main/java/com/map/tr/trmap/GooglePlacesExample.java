...
public class GooglePlacesExample  extends ListActivity {
    ...
    final String GOOGLE_KEY = "AIzaSyBW3E_SlWb3nnQE5ubYYEl8TLT-Jqek15I";

    // we will need to take the latitude and the logntitude from a certain point
    final String latitude = "26.755";
    final String longtitude = "83.37389";
    ...
    private class googleplaces extends AsyncTask<View, Void, String> {
        ...
        protected String doInBackground(View... urls) {
            ...
            temp = makeCall("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=" + latitude + "," + longtitude + "&radius=1000&keyword='hotel'&key=" + GOOGLE_KEY);

            //print the call in the console
            System.out.println("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=" + latitude + "," + longtitude + "&radius=1000&keyword='hotel'&key=" + GOOGLE_KEY);
            return "";
        }
